...
w1=570;
w2=749;
filename="C:\Users\kenya\Desktop\ramdomforests_trainningSiO2\S3_2\20190202_RT\001S3_2PLWSe2SiO2300KCW633nm30uW20s_";
...
colorbar
grid on
saveas(gcf,"PL_room_plus_reshape.png");
close
% figure
% image(mapping_m_re,"CDataMapping","scaled")
% colorbar
% grid on
% saveas(gcf,"SiO2_1\\PL_minus_reshape.png");
% close