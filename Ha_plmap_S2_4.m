...
if(exist(strcat(samplename,".mat"),"file")>0)
    ...
    %     "each load"
    FilenameRT = replace("RT/001S2_4PLWSe2SiO2300KCW633nm30uW20s_%.0f_1.txt","/","//");
    FilenameLT = replace("LT/002S2_4PLWSe2SiO215KCW633nm30uW20s_%.0f_1.txt","/","//");
    pickupLT = 543:578;
    pickupRT = 570:740;
...
%cosmic ray cut
Inteinsity_sigm_rt(Inteinsity_sigm_rt>350) = 0;
Inteinsity_sigp_rt(Inteinsity_sigp_rt>350) = 0;
...
mapping_m_lt(mapping_m_lt<0.4*mean(mapping_m_lt(:))) = 0;
mapping_p_lt(mapping_p_lt<0.4*mean(mapping_p_lt(:))) = 0;
