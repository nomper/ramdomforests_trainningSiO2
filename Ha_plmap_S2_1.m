...
if(exist(strcat(samplename,".mat"),"file")>0)
    ...
    %     "each load"
    FilenameRT = replace("RT/000S2_1PLWSe2SiO2300KCW633nm20uW20s_%.0f_1.txt","/","//");
    FilenameLT = replace("LT/003S2_1PLWSe2SiO215KCW633nm30uW20s_%.0f_1.txt","/","//");
    pickupLT = 543:578;
    pickupRT = 570:740;
...
Inteinsity_sigm_rt(Inteinsity_sigm_rt>100) = 0;
Inteinsity_sigp_rt(Inteinsity_sigp_rt>100) = 0;
