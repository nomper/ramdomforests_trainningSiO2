...
if(exist(strcat(samplename,".mat"),"file")>0)
    ...
    %     "each load"
    FilenameRT = replace("20190201_RT/001S3_5PLWSe2SiO2300KCW633nm30uW20s_%.0f_1.txt","/","//");
    FilenameLT = replace("20190130_LT/001S3_5PLWSe2SiO215KCW633nm30uW20s_%.0f_1.txt","/","//");
    pickupLT = 543:578;
    pickupRT = 570:740;
