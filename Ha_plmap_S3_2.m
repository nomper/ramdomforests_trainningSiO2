...
%cosmic ray cut
Inteinsity_sigm_rt(Inteinsity_sigm_rt>650) = 0;
Inteinsity_sigp_rt(Inteinsity_sigp_rt>650) = 0;
Inteinsity_sigm_lt(Inteinsity_sigm_lt>1200) = 0;
Inteinsity_sigp_lt(Inteinsity_sigp_lt>1200) = 0;
...
mapping_m_lt(mapping_m_lt<0.00*max(mapping_m_lt(:))) = 0;
mapping_p_lt(mapping_p_lt<0.00*max(mapping_p_lt(:))) = 0;
...
mapping_v_rt(isnan(mapping_v_rt)|(abs(mapping_v_rt)>1)) = 0;
mapping_v_lt(isnan(mapping_v_lt)|(abs(mapping_v_lt)>1)) = 0;
mapping_v_rt(~(mapping_p_rt&mapping_m_rt&mapping_p_lt&mapping_m_lt)) = 0;
mapping_v_lt(~(mapping_p_rt&mapping_m_rt&mapping_p_lt&mapping_m_lt)) = 0;
